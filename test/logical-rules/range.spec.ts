 ...
 */
describe('isGt', () => {
  it('should validate number value is greater than minValue', () => {
  ...
  it('should validate bigint value is greater than minValue', () => {
    expect(vg.isGt(BigInt(5))(BigInt(6))).toStrictEqual(BigInt(6));
    expect(vg.isGt(BigInt(5))(6)).toStrictEqual(6);
    expect(() => vg.isGt(BigInt(5))(BigInt(5))).toThrow(
      'must be greater than 5',
    );
    expect(() => vg.isGt(BigInt(5))(5)).toThrow('must be greater than 5');
    expect(() => vg.isGt(BigInt(5))('x' as any)).toThrow(
      'must be greater than 5',
    );
  });

  it('should validate Date value is greater than minValue', () => {
    const minDate = new Date('2020-06-01T10:00:00');
    expect(vg.isGt(minDate)(new Date('2020-06-02T10:00:00'))).toStrictEqual(
      new Date('2020-06-02T10:00:00'),
    );
    expect(() => vg.isGt(minDate)(minDate)).toThrow('must be greater than');
    expect(() => vg.isGt(minDate)(new Date('2020-05-01T10:00:00'))).toThrow(
      'must be greater than',
    );
    expect(() => vg.isGt(minDate)('x' as any)).toThrow('must be greater than');
  });

  it('should validate string value is greater than minValue', () => {
  ...
  it('should validate string value is greater than minValue - caseInsensitive', () => {
 ...
 */
describe('isGte', () => {
  it('should validate number value is greater or equal to than minValue', () => {
    ...
    expect(() => vg.isGte(5)('x' as any)).toThrow(
      'must be greater than or equal to 5',
    );
  });

  it('should validate bigint value is greater or equal to than minValue', () => {
    ...
    expect(() => vg.isGte(BigInt(5))(BigInt(4))).toThrow(
      'must be greater than or equal to 5',
    );
    expect(() => vg.isGte(BigInt(5))(4)).toThrow(
      'must be greater than or equal to 5',
    );
    expect(() => vg.isGte(BigInt(5))('x' as any)).toThrow(
      'must be greater than or equal to 5',
    );
  });

  it('should validate Date value is greater than or equal to minValue', () => {
    const minDate = new Date('2020-06-01T10:00:00');
    expect(vg.isGte(minDate)(new Date('2020-06-02T10:00:00'))).toStrictEqual(
      new Date('2020-06-02T10:00:00'),
    );
    expect(vg.isGte(minDate)(minDate)).toStrictEqual(minDate);
    expect(() => vg.isGte(minDate)(new Date('2020-05-01T10:00:00'))).toThrow(
      'must be greater than',
    );
    expect(() => vg.isGte(minDate)('x' as any)).toThrow('must be greater than');
  });

  it('should validate string value is greater than or equal to minValue', () => {
    expect(vg.isGte('B')('B')).toStrictEqual('B');
    expect(vg.isGte('B')('C')).toStrictEqual('C');
    expect(() => vg.isGte('B')('A')).toThrow(
      'must be greater than or equal to "B"',
    );
    expect(() => vg.isGte('b')('C')).toThrow(
      'must be greater than or equal to "b"',
    );
    expect(() => vg.isGte('B')(5 as any)).toThrow(
      'must be greater than or equal to "B"',
    );
  });

  it('should validate string value is greater than or equal to minValue - caseInsensitive', () => {
    expect(vg.isGte('abc', { caseInsensitive: true })('ABD')).toStrictEqual(
      'ABD',
    );
    expect(vg.isGte('abc', { caseInsensitive: true })('ABC')).toStrictEqual(
      'ABC',
    );
  });
});
...
describe('lengthMin', () => {
  it('should validate the length is at least minValue', () => {
...
describe('lengthMax', () => {
  it('should validate the length is at most maxValue', () => {
    ...
    expect(() => vg.lengthMax(3)('1245')).toThrow(
      'The length of Value must be at most 3',
    );
    expect(() => vg.lengthMax(3)([1, 2, 3, 4])).toThrow(
      'The length of Value must be at most 3',
    );
  });
});
